...
#         return DataFrame(diccionario_nuevo)
    ...
    def __getitem__(self,item):
        '''
        Con la funcion getitem se puede imprimir los valores de las filas de un diccionario, ya sea por un slice
        de enteros(df[0:0]) o por un slice de strigs(df["A":"B"]) segun lo desee.
        ejemplos:
